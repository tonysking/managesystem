    ...
    <div class="modal-dialog" style="width: 600px; role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--超出部分显示滚动条 -->
                <div class="contentDiv" style="height:240px;overflow:auto; ">
                <form class="form-horizontal">
                    <label for="inputPassword3" class="col-sm-2 control-label">活动名称</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" readonly id="actTitle" >
                    </div>
                    <label for="inputPassword3" class="col-sm-2 control-label">活动简介</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" readonly id="actDetailInfo"></textarea>
                    </div>
                    <label for="inputPassword3" class="col-sm-2 control-label">活动地址</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" readonly id="actAddress" >
                    </div>
                    <label for="inputPassword3" class="col-sm-2 control-label">活动人数</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" readonly id="participantsNumber" >
                    </div>
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" readonly id="actStatus" >
                    </div>
                    <label for="inputPassword3" class="col-sm-2 control-label">截止时间</label>
                    <div class="col-sm-4">
                        <input type="datetime" class="form-control" readonly id="actSignupDeadline" >
                    </div>
                    <label for="inputPassword3" class="col-sm-2 control-label">开始时间</label>
                    <div class="col-sm-4">
                        <input type="datetime" class="form-control" readonly id="actStartTime">
                    </div>
            ...
            <div class="modal-body">
                <!--超出部分显示滚动条 -->
                <div class="contentDiv" style="height:220px; ">
                    <form class="form-horizontal">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" readonly id="sex"></textarea>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" readonly id="school">
                        </div>
...
<button style="display: none" value="${userId}" id="userIdBtn"></button>
<div class="wrapper wrapper-content  animated fadeInRight">
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>用户${userNickName}参与的活动</h5>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list").bootstrapTable({
            ...
            //获取数据的Servlet地址
            url: "${ctx!}/admin/user/${userId}/signup",
            //表格显示条纹
            striped: true,
            //启动分页
            pagination: true,
    ...
    function lookover(actId){
        var userId = $("#userIdBtn").val();
        $.ajax({
            type: "GET",
            url: "/admin/activity/"+actId+"/usersignup/"+userId,
            dataType: "json",
            success: function(data){
                console.log(data);
                ...
                if(typeof detail.age === "undefined" || detail.age == null || detail.age === ""){
                    $("#age").val("未填");
                }else{
                    $("#age").val(detail.age);
                }
                if(typeof detail.school === "undefined" || detail.age == null || detail.age === ""){
                    $("#school").val("未填");
                }else{
